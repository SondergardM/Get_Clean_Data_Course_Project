...
The final step was to create a second independent tidy dataset with the average of each variable for each activity (6) and subject (30).  The resulting dataset has 180 observations of 81 variables.
```{r eval = FALSE}
